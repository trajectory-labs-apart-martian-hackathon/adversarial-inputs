...
TRAIN_RUBRICS = ['RUBRIC_TWENTY_FOUR_OBJECTIVITY_FOCUS', 'RUBRIC_SEVEN_USER_COMFORT', 'RUBRIC_TWENTY_FIVE_IMPACT_BASED', 'RUBRIC_FOUR_FAWNING_BINARY', 'RUBRIC_TEN_NARRATIVE_MIXED', 'RUBRIC_NINE_PUNCHY', 'RUBRIC_ONE_SYCOPHANCY_NEG_SCALE', 'RUBRIC_TWENTY_THREE_PROFESSIONAL_MINIMAL', 'RUBRIC_TWELVE_FORMAL_PROSE', 'RUBRIC_SIX_EXTREME_RANGE', 'RUBRIC_THREE_OBSEQUIOUSNESS_FORMAL_DESC', 'RUBRIC_TWENTY_TWO_GRADIENT_PARAGRAPH', 'RUBRIC_ELEVEN_NORMAL_PARAGRAPHS', 'RUBRIC_EIGHTEEN_TWO_OPTIONS_SIMPLE', 'RUBRIC_EIGHT_TECHNICAL_INDICATORS', 'RUBRIC_THIRTY_SINGLE_PARAGRAPH_DESCRIPTIVE']

TEST_RUBRICS = ['RUBRIC_TWENTY_SIX_CONCISE_NUMERIC', 'RUBRIC_NINETEEN_FEWER_DEFINED_PARAGRAPHS', 'RUBRIC_FOURTEEN_ABSENCE_OF_OBJECTIVITY', 'RUBRIC_TWENTY_ONE_COMPACT_FORMAL', 'RUBRIC_FIFTEEN_DESCRIPTIVE_PARAGRAPHS', 'RUBRIC_SIXTEEN_SLIGHTLY_OFFBEAT_TYPOS', 'RUBRIC_TWENTY_INTERNAL_MONOLOGUE', 'RUBRIC_SEVENTEEN_REVERSED_SCALE_PLAIN', 'RUBRIC_TWENTY_NINE_QUALITATIVE_TIERS', 'RUBRIC_TWO_BROWNNOSING_INFORMAL', 'RUBRIC_THIRTEEN_CASUAL_INFERRED', 'RUBRIC_FIVE_BOTLICKER_TYPOS', 'RUBRIC_TWENTY_EIGHT_OBSERVATIONAL', 'RUBRIC_SYCOPHANCY', 'RUBRIC_TWENTY_SEVEN_NEUTRALITY_SPECTRUM']
